...
transactionbook_df.to_csv("../res/OTMStrikeSell_"+str(call_premium)+"_Premium_Resell_OneLeg1_"+str(individual_stoploss_fraction)+".csv", index = False) 

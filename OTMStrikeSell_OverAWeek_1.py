...
individual_stoploss_fraction = "inf"
...
# '15-07-2022',
# '22-07-2022']
# dates not present = "05-02-2021","26-03-2021",'05-04-2021','09-04-2021','04-03-2022'
        ...
        for index_,row in tqdm(time_temp[time_temp.index >= start_time].iterrows()):
            ...
            if (check_individual_stoploss == True):
                ...
                if((put_profit < -1*(individual_stoploss_fraction)*(put_sell_price)) & (put_position_active == True)):
                    ...
                    transactionbook.append([trade_start_date, date_name,expiry_date, start_time_t, future_price, call_file_name[:-10], put_file_name[:-10],start_atm_IV, np.nan, put_sell_price,trade_end_date, stop_date_name, np.nan,index_,future_price_end, end_atm_IV,np.nan, put_buy_price,min_profit,max_profit,trade_type_call,trade_type_put])
...
transactionbook_df.to_csv("../res/OTMStrikeSell_20_Premium_Selling_"+str(individual_stoploss_fraction)+".csv", index = False) 

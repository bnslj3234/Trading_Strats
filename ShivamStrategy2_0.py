...
transactions_book = [["Date", 'Day',"Time","FuturesPrice","vix",'Upper_Band2','Upper_Band1','Lower_Band1','Lower_Band2','Instrument_NameL', 'BuyPriceL','BuyQtyL','Instrument_NameS', 'SellPriceS', 'SellQtyS', 'SellPriceL','SellQtyL','BuyPriceS','BuyQtyS',"Profit","trade_type"]]
    ...
    for index_ in tqdm(df_weekly_futures.Time[(df_weekly_futures.Time >= start_time) & (df_weekly_futures.Time <= end_time)]):
        ...
        if((put_qtyL == 0) & (call_qtyL == 0)):
            ...
            if(put_buy_signal == 1):
                ...
                transactions_book.append([date,date_name,index_,future_price,vixdf.loc[date].values[0],upper_band2,upper_band1,lower_band1,lower_band2,put_file_nameL[:-8],buy_price_putL,put_qtyL,put_file_nameS[:-8],sell_price_putS,put_qtyS,0,0,0,0,0,trade_type])
                put_buy_signal = 0 
            ...
            if(call_buy_signal == 1):
                ...
                transactions_book.append([date,date_name,index_,future_price,vixdf.loc[date].values[0],upper_band2,upper_band1,lower_band1,lower_band2,call_file_nameL[:-8],buy_price_callL,call_qtyL,call_file_nameS[:-8],sell_price_callS,call_qtyS,0,0,0,0,0,trade_type])
        ...
        if(index_ <= last_trade_open_time):
            ...
            if (current_future_price > upper_band1):
                ...
                if (put_qtyL !=0) : 
                    ...
                    transactions_book.append([date,date_name,index_,current_future_price,vixdf.loc[date].values[0],upper_band2,upper_band1,lower_band1,lower_band2,put_file_nameL[:-8],0,0,put_file_nameS[:-8],0,0,sell_price_putL,put_qtyL,buy_price_putS,put_qtyS,profit,trade_type])
                    put_qtyL = 0
                    put_qtyS = 0
                ...
                if (call_qtyL !=0):
                    ...
                    transactions_book.append([date,date_name,index_,current_future_price,vixdf.loc[date].values[0],upper_band2,upper_band1,lower_band1,lower_band2,call_file_nameL[:-8],0,0,call_file_nameS[:-8],0,0,sell_price_callL,call_qtyL,buy_price_callS,call_qtyS,profit,trade_type])
                    call_qtyL = 0
                    call_qtyS = 0
                ...
                transactions_book.append([date,date_name,index_,current_future_price,vixdf.loc[date].values[0],upper_band2,upper_band1,lower_band1,lower_band2,call_file_nameL[:-8],buy_price_callL,call_qtyL,call_file_nameS[:-8],sell_price_callS,call_qtyS,0,0,0,0,0,trade_type])
                total_transactions+=1
            ...
            # elif(time_temp['Futures_Price'].loc[index_] < lower_band):
                ...
                transactions_book.append([date,date_name,index_,current_future_price,vixdf.loc[date].values[0],upper_band2,upper_band1,lower_band1,lower_band2,put_file_nameL[:-8],buy_price_putL,put_qtyL,put_file_nameS[:-8],sell_price_putS,put_qtyS,0,0,0,0,0,trade_type])
                total_transactions+=1
                ref_future_price = current_future_price
